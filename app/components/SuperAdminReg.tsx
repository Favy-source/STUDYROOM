      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex border-b border-gray-500 items-center gap-3 py-1 text-gray-400">
          ...
          >
            ...
            <option className="bg-black text-white p-1" value="Civil Engineering">Civil Engineering</option>
            <option className="bg-black text-white p-1" value="Computer Engineering">Computer Engineering</option>
            <option className="bg-black text-white p-1" value="Electrical/Electronics Engineering">Electrical/Electronics Engineering</option>
            <option className="bg-black text-white p-1" value="Mechanical Engineering">Mechanical Engineering</option>
            <option className="bg-black text-white p-1" value="Information Communication Technology">Information Communication Technology</option>
          </select>
        </div>
